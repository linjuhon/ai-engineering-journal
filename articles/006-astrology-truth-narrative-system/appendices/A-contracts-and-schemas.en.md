[← Back to technical index](../TECHNICAL_INDEX.en.md) | **English** | [繁體中文](A-contracts-and-schemas.md)

---

# Appendix A: Component Contracts and Schemas

> **Maturity:** PROVISIONAL (schemas must be updated together with the implementation)
...
The `global_arc` values are retained as canonical machine literals: `建立` (establishment), `堆疊` (buildup), `轉折` (turn), and `收束` (closure).
